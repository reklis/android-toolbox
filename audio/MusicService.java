...
package com.cibotechnology.radio;
...
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener, OnErrorListener, MusicFocusable,
    ...
    final static String CONTENT_TITLE = "";
    final static String SONG_TITLE = "";
    ...
    // our service in
    // AndroidManifest.xml.
    public static final String ACTION_PLAY = "com.cibotechnology.radio.action.PLAY";
    public static final String ACTION_PAUSE = "com.cibotechnology.radio.action.PAUSE";
    public static final String ACTION_STOP = "com.cibotechnology.radio.action.STOP";
    public static final String ACTION_SKIP = "com.cibotechnology.radio.action.SKIP";
    public static final String ACTION_REWIND = "com.cibotechnology.radio.action.REWIND";
    public static final String ACTION_URL = "com.cibotechnology.radio.action.URL";
